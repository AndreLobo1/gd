...
| 5   | Teste de Trilha Sonora                         | O jogo está em andamento                               | Não é necessária nenhuma ação do jogador                                     | A trilha sonora do jogo deve tocar constantemente enquanto o jogador estiver na aba do jogo e                                                                                           |
...
| 7   | Teste de Interação com NPCs                         | O jogo está em andamento e o personagem está próximo ao NPC| Se aproximar do NPCs do jogo e acionar a tecla de interação "E"                                                                        | O NPC deve mostrar um balão de fala indicando a tecla "E" e, ao interagir, o NPC deve falar com o jogador através de outro balão de fala. Além disso, o balão de fala deve mostrar uma foto do NPC ao lado dele. Sempre que o jogador acionar a tecla de interação "E" dentro de um diálogo, o som de interação deve ser ativado. O texto da fala sempre deve ficar dentro dele. O NPC sempre deve chamar o jogador pelo nome que ele inseriu no inicio do jogo. NPCs não humanos como o computador devem direcionar o jogador para um minigame |

| 8   | Teste de transição para o Minigame de hack.                                | O jogador esta dentro do escritório e está próximo ao computador                            | O jogador interage com o computador dentro do escritório.                                     | A tela do minigame deve abrir normalmente e a sua trilha sonora deve comecar a tocar.                                                                                                     |
